# Walking through the React Docs

This is simply code snippets written from [React Docs](https://www.reactjs.org/docs). Just things I was walking through whilst learning react.

The docs cover the following:
1. Hello World
2. Introducing JSX
...
*Ignore the fact that no file / folder structure was used, this is just tinkering with the framework*
